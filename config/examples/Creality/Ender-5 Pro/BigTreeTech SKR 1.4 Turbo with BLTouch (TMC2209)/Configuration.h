...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5 Pro/BigTreeTech SKR 1.4 Turbo with BLTouch (TMC2209)"
...
#define CUSTOM_MACHINE_NAME "Ender-5 Pro BTT SKR 1.4 Turbo"
 ...
 */
#if ENABLED(MESH_BED_LEVELING) || ENABLED(AUTO_BED_LEVELING)
